-- SoftWorld War 8.60 Server Config
	...
	maxPlayers = 977
	motd = "Welcome to the SoftWorld  War!"
	displayOnOrOffAtCharlist = false
	onePlayerOnlinePerAccount = false
	allowClones = false
	serverName = "SoftWorld War 8.60"
	loginMessage = "Welcome to the SoftWorld  War!"
