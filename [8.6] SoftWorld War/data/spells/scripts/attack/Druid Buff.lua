...
setConditionParam(condition2, CONDITION_PARAM_HEALTHGAIN, 15)
...
setConditionParam(condition3, CONDITION_PARAM_STAT_MAXHEALTHPERCENT, 107)
setConditionParam(condition3, CONDITION_PARAM_STAT_MAXMANAPERCENT, 105)
...
setConditionParam(condition4, CONDITION_PARAM_STAT_MAGICPOINTS, 1)
...
setConditionParam(condition5, CONDITION_PARAM_HEALTHTICKS, 5000)
