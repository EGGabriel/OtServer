local config = 
 {
  pontaDeCima = {x=242, y=140, z=7},   -- Localização da ponta do tapete que tem no templo   << /\.
   pontaDeBaixo = {x=244, y=142, z=7},   -- Localização da ponta do tapete que tem no templo   >> \/.
  toPos = {x=129, y=85, z=7},   -- Para onde o player será teleportado após falar !arena.
