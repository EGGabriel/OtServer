...
setConditionFormula(condition, 3.0, -100, 3.0, -100)
...
doSendDistanceShoot(getPlayerLookPos(cid), pos1, 37)
doSendDistanceShoot(getPlayerLookPos(cid), pos2, 37)
doSendDistanceShoot(getPlayerLookPos(cid), pos3, 37)
