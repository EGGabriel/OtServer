...
selfSay("que te crei sako de weas pegandole a los demas player ctm!")
end
...
doTargetCombatHealth(getNpcCid(), target, COMBAT_LIFEDRAIN, -999999999, -999999999999, CONST_ME_EXPLOSIONAREA)
lastAttack = os.clock()
end
end