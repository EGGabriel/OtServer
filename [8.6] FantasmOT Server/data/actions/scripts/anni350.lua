...
if item.uid == 5000 then
 ...
 player1pos = {x=87, y=273, z=15, stackpos=253}
 player1 = getThingfromPos(player1pos)

 player2pos = {x=86, y=273, z=15, stackpos=253}
 player2 = getThingfromPos(player2pos)

 player3pos = {x=85, y=273, z=15, stackpos=253}
 player3 = getThingfromPos(player3pos)

 player4pos = {x=84, y=273, z=15, stackpos=253}
 player4 = getThingfromPos(player4pos)
  ...
  if player1level >= questlevel and player2level >= questlevel and player3level >= questlevel and player4level >= questlevel then
   ...
   doSummonCreature("Demon", demon6pos)
	...
	nplayer1pos = {x=152, y=228, z=15}
	nplayer2pos = {x=151, y=228, z=15}
	nplayer3pos = {x=150, y=228, z=15}
	nplayer4pos = {x=149, y=228, z=15}
